...
class OlogyBrewingDatabase {
    public static function create_tables() {
        ...
        // Beers table
        $beers_table = $wpdb->prefix . 'ology_brewing_beers';
        ...
        // Locations table
        $locations_table = $wpdb->prefix . 'ology_brewing_locations';
        ...
        // Sync logs table
        $sync_logs_table = $wpdb->prefix . 'ology_brewing_sync_logs';
    ...
    public static function drop_tables() {
        ...
        $tables = [
            $wpdb->prefix . 'ology_brewing_beers',
            $wpdb->prefix . 'ology_brewing_locations',
            $wpdb->prefix . 'ology_brewing_sync_logs'
        ];
